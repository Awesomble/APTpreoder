...
// 당해
if (surportArea.value[0] === 1 && surportArea.value[1] === 14) {
  if (dayjs(noticeDt).diff(dayjs(surportAreaYMD.value), 'day') >= 730) {
...
<template>
  <li>
    <table class="aptTable">
      ...
      <tbody>
      <tr class="type">
        <td class="thubm" style="background-color: #F8C25C;">
          A2,4
        </td>
        <td colspan="2" class="tit">경기도 안산 신길2</td>
      </tr>
      <tr class="score">
        <td>신혼·한부모</td>
        <td>
