...
console.log(familyChildrenYMD.value)
// ❤우선공급
...
if (surportArea.value[0] !== 2) score1.value = 0 // 인천이외 부적격
...
if (surportArea.value[0] !== 2) score2.value = 0 // 인천이외 부적격
